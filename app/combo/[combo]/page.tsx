...
Object.assign(
  COMBINATION_GUIDES,
  Object.fromEntries([...GENERATED_COMBINATION_GUIDE_CONFIGS, ...BATCH3_COMBINATION_GUIDE_CONFIGS, ...BATCH4_COMBINATION_GUIDE_CONFIGS].map(config => [config.slug, makeGeneratedCombinationGuide(config)]))
);
