...
const BATCH4_COMBINATION_GUIDE_CONFIGS: GeneratedCombinationGuideConfig[] = [
  {
    slug: 'electric-grass',
    type1: 'electric',
    type2: 'grass',
    headline: 'pivot pressure with four direct weaknesses',
    examples: ['Mow Rotom', 'Hisuian Voltorb', 'Hisuian Electrode'],
    role: 'Electric/Grass is a pressure pairing that threatens Water, Flying, Ground, and Rock targets while resisting Electric, Grass, Steel, and Water interactions.',
    offense: 'Electric STAB threatens Water and Flying targets, while Grass STAB pressures Water, Ground, and Rock targets. Fire, Ice, Poison, and Bug are the chart weaknesses, so the user needs careful positioning against common coverage. The pairing is strongest when it can pivot or force Water and Ground answers to respect both STAB options.',
    teamBuilding: 'Electric/Grass needs Fire, Ice, Poison, and Bug answers. Steel, Fire, Flying, and Water partners can cover those lanes while Electric/Grass checks Water and Electric pressure.',
    related: ['water-electric', 'grass-ground'],
  },
  {
    slug: 'fire-fairy',
    type1: 'fire',
    type2: 'fairy',
    headline: 'Dragon immunity with four 2× weaknesses',
    examples: [],
    role: 'Fire/Fairy is a theoretical pairing with useful Dragon control and strong pressure into Steel, Grass, Ice, Bug, Dark, and Fighting lanes.',
    offense: 'Fire STAB threatens Grass, Ice, Bug, and Steel targets, while Fairy STAB pressures Dragon, Dark, and Fighting targets. Water, Poison, Ground, and Rock all hit for 2×, so the chart asks for broad support even though there is no 4× weakness. The page covers the combination itself; there are no established Pokemon with this exact typing.',
    teamBuilding: 'Fire/Fairy needs Water, Poison, Ground, and Rock answers. Steel, Flying, Water, and Ground-immune partners can cover those lanes while Fire/Fairy supplies Dragon immunity on the chart.',
    related: ['fire-steel', 'dark-fairy'],
  },
  {
    slug: 'fire-water',
    type1: 'fire',
    type2: 'water',
    headline: 'balanced resistances with three weaknesses',
    examples: ['Volcanion'],
    role: 'Fire/Water is a rare pairing that pressures Steel, Grass, Ice, Bug, Fire, Ground, and Rock targets while resisting several common attacking lanes.',
    offense: 'Fire STAB threatens Grass, Ice, Bug, and Steel targets, while Water STAB threatens Fire, Ground, and Rock targets. Electric, Ground, and Rock are the direct weaknesses, and there is no 4× weakness. The typing is valuable when it can exploit its unusual resistance profile without being forced into Earthquake or Rock coverage.',
    teamBuilding: 'Fire/Water wants Electric, Ground, and Rock answers. Grass, Ground-immune, Steel, and bulky Water partners can help while Fire/Water pressures Fire and Steel structures.',
    related: ['fire-ground', 'water-steel'],
  },
  {
    slug: 'dragon-fairy',
    type1: 'dragon',
    type2: 'fairy',
    headline: 'Dragon immunity with four 2× weaknesses',
    examples: ['Mega Altaria'],
    role: 'Dragon/Fairy combines broad Dragon pressure with a Dragon immunity, creating a rare mirror-control profile.',
    offense: 'Dragon STAB supplies broad neutral damage, while Fairy STAB threatens Dragon, Dark, and Fighting targets. Ice, Poison, Steel, and Fairy all hit for 2×, and Steel is especially important because it pressures Fairy while resisting Dragon. The typing needs support against Steel and Poison answers before it can use its immunities comfortably.',
    teamBuilding: 'Dragon/Fairy needs Ice, Poison, Steel, and Fairy support. Fire, Steel, Ground, and Poison-resistant partners can cover those lanes while Dragon/Fairy handles Dragon pressure.',
    related: ['dragon-fire', 'psychic-fairy'],
  },
  {
    slug: 'electric-ground',
    type1: 'electric',
    type2: 'ground',
    headline: 'Electric immunity with four 2× weaknesses',
    examples: ['Stunfisk', 'Sandy Shocks'],
    role: 'Electric/Ground is a coverage-heavy pairing that blocks Electric while threatening Water, Flying, Electric, Fire, Poison, Rock, and Steel targets.',
    offense: 'Electric STAB threatens Water and Flying targets, while Ground STAB pressures Electric, Fire, Poison, Rock, and Steel targets. Water, Grass, Ice, and Ground all hit for 2×, so the typing needs support against common coverage. Its Electric immunity helps it enter on Volt Switch-style pressure and threaten back immediately.',
    teamBuilding: 'Electric/Ground wants Water, Grass, Ice, and Ground answers. Grass, Water, Flying, and Ice-resistant partners can cover those lanes while Electric/Ground controls Electric matchups.',
    related: ['water-electric', 'poison-ground'],
  },
  {
    slug: 'grass-flying',
    type1: 'grass',
    type2: 'flying',
    headline: 'Ground immunity with a 4× Ice alarm',
    examples: ['Hoppip', 'Skiploom', 'Jumpluff', 'Tropius', 'Shaymin Sky'],
    role: 'Grass/Flying is a utility pairing that blocks Ground while resisting Water, Grass, Fighting, and Ground-adjacent pressure.',
    offense: 'Grass STAB threatens Water, Ground, and Rock targets, while Flying STAB pressures Grass, Fighting, and Bug targets. Ice is the severe 4× weakness, and Fire, Poison, Flying, and Rock also hit for 2×. The typing needs clear Ice and hazard support before it can switch repeatedly.',
    teamBuilding: 'Grass/Flying needs Ice protection first, then Fire, Poison, Flying, and Rock answers. Steel, Fire, Water, and Rock-resistant partners can cover those lanes while Grass/Flying offers Ground immunity.',
    related: ['grass-ground', 'flying-fairy'],
  },
  {
    slug: 'grass-rock',
    type1: 'grass',
    type2: 'rock',
    headline: 'Rock pressure with four 2× weaknesses',
    examples: ['Lileep', 'Cradily', 'Ogerpon Cornerstone Mask'],
    role: 'Grass/Rock pressures Water, Ground, Flying, Fire, Ice, and Bug targets while carrying a manageable but awkward defensive chart.',
    offense: 'Grass STAB threatens Water, Ground, and Rock targets, while Rock STAB pressures Flying, Fire, Ice, and Bug targets. Ice, Fighting, Bug, and Steel are the direct weaknesses, and there is no immunity. The typing works best when its user has recovery, utility, or enough power to punish switch-ins.',
    teamBuilding: 'Grass/Rock needs Ice, Fighting, Bug, and Steel answers. Fire, Flying, Ghost, Steel, and bulky Water partners can cover those lanes while Grass/Rock pressures Water and Flying structures.',
    related: ['grass-ground', 'ground-rock'],
  },
  {
    slug: 'ground-fairy',
    type1: 'ground',
    type2: 'fairy',
    headline: 'Electric and Dragon immunities with four 2× weaknesses',
    examples: [],
    role: 'Ground/Fairy is a theoretical pairing that blocks Electric and Dragon while threatening Poison, Rock, Steel, Fire, Electric, Dragon, Dark, and Fighting targets.',
    offense: 'Ground STAB threatens Electric, Fire, Poison, Rock, and Steel targets, while Fairy STAB pressures Dragon, Dark, and Fighting targets. Water, Grass, Ice, and Steel all hit for 2×, and there is no 4× weakness. The page covers the combination itself; there are no established Pokemon with this exact typing.',
    teamBuilding: 'Ground/Fairy needs Water, Grass, Ice, and Steel answers. Fire, Water, Steel, and Grass-resistant partners can cover those lanes while Ground/Fairy supplies Electric and Dragon immunities on the chart.',
    related: ['poison-ground', 'electric-fairy'],
  },
  {
    slug: 'water-dark',
    type1: 'water',
    type2: 'dark',
    headline: 'Psychic immunity with five 2× weaknesses',
    examples: ['Carvanha', 'Sharpedo', 'Crawdaunt', 'Greninja', 'Mega Gyarados'],
    role: 'Water/Dark is an aggressive and disruptive pairing that blocks Psychic while threatening Fire, Ground, Rock, Ghost, and Psychic targets.',
    offense: 'Water STAB threatens Fire, Ground, and Rock targets, while Dark STAB pressures Ghost and Psychic targets. Electric, Grass, Fighting, Bug, and Fairy all hit for 2×, so the typing needs strong positioning. It often works best through speed, pivoting, setup, or immediate wallbreaking pressure.',
    teamBuilding: 'Water/Dark needs Electric, Grass, Fighting, Bug, and Fairy answers. Steel, Poison, Flying, Grass, and Fairy partners can cover those lanes while Water/Dark gives Psychic immunity.',
    related: ['water-fighting', 'fighting-dark'],
  },
  {
    slug: 'water-bug',
    type1: 'water',
    type2: 'bug',
    headline: 'three weaknesses and strong utility pressure',
    examples: ['Surskit', 'Dewpider', 'Araquanid', 'Wimpod', 'Golisopod'],
    role: 'Water/Bug pressures Fire, Ground, Rock, Psychic, Dark, and Grass targets while resisting Fighting, Ground, Steel, Ice, and Water lanes.',
    offense: 'Water STAB threatens Fire, Ground, and Rock targets, while Bug STAB pressures Psychic, Dark, and Grass targets. Electric, Flying, and Rock are the direct weaknesses, and there is no 4× weakness. The typing appreciates support against hazards and strong Flying or Electric coverage.',
    teamBuilding: 'Water/Bug wants Electric, Flying, and Rock answers. Ground, Steel, Electric, and bulky Water partners can help while Water/Bug pressures Ground and Dark structures.',
    related: ['water-rock', 'poison-bug'],
  },
  {
    slug: 'ground-steel',
    type1: 'ground',
    type2: 'steel',
    headline: 'Electric and Poison immunities with four 2× weaknesses',
    examples: ['Steelix', 'Excadrill', 'Iron Treads', 'Alolan Dugtrio', 'Galarian Stunfisk'],
    role: 'Ground/Steel is a high-compression defensive and offensive pairing that blocks Electric and Poison while threatening many common targets.',
    offense: 'Ground STAB threatens Electric, Fire, Poison, Rock, and Steel targets, while Steel STAB pressures Fairy, Ice, and Rock targets. Fire, Water, Fighting, and Ground all hit for 2×. The typing needs support against those lanes but rewards it with valuable immunities and many resistances.',
    teamBuilding: 'Ground/Steel needs Fire, Water, Fighting, and Ground answers. Flying, Water, Grass, Fairy, and Ghost partners can cover those lanes while Ground/Steel anchors Electric and Poison matchups.',
    related: ['dragon-steel', 'poison-ground'],
  },
  {
    slug: 'ground-bug',
    type1: 'ground',
    type2: 'bug',
    headline: 'Electric immunity with four 2× weaknesses',
    examples: ['Nincada', 'Sandy Wormadam'],
    role: 'Ground/Bug blocks Electric while resisting Fighting, Ground, and Poison pressure and threatening Electric, Fire, Psychic, Dark, Rock, and Steel targets.',
    offense: 'Ground STAB threatens Electric, Fire, Poison, Rock, and Steel targets, while Bug STAB pressures Psychic, Dark, and Grass targets. Fire, Water, Ice, and Flying all hit for 2×, so the typing needs careful defensive support. It is best used for targeted entries rather than broad walling.',
    teamBuilding: 'Ground/Bug wants Fire, Water, Ice, and Flying answers. Water, Rock, Fire-resistant, and Steel partners can cover those lanes while Ground/Bug offers Electric immunity.',
    related: ['poison-bug', 'ground-dark'],
  },
  {
    slug: 'fire-psychic',
    type1: 'fire',
    type2: 'psychic',
    headline: 'special pressure with five 2× weaknesses',
    examples: ['Victini', 'Delphox', 'Armarouge', 'Zen Mode Darmanitan'],
    role: 'Fire/Psychic threatens Steel, Grass, Ice, Bug, Fighting, and Poison targets while resisting Fire, Grass, Ice, Fighting, Psychic, Steel, and Fairy.',
    offense: 'Fire STAB threatens Grass, Ice, Bug, and Steel targets, while Psychic STAB pressures Fighting and Poison targets. Water, Ground, Rock, Ghost, and Dark all hit for 2×. The typing rewards speed, setup, or pivot support because several common coverage lanes can punish careless entries.',
    teamBuilding: 'Fire/Psychic needs Water, Ground, Rock, Ghost, and Dark answers. Grass, Flying, Fairy, Dark, and Water partners can cover those lanes while Fire/Psychic pressures Steel and Fighting structures.',
    related: ['dragon-fire', 'psychic-steel'],
  },
  {
    slug: 'grass-bug',
    type1: 'grass',
    type2: 'bug',
    headline: 'two 4× weaknesses and useful Grass pressure',
    examples: ['Paras', 'Parasect', 'Plant Cloak Wormadam', 'Sewaddle', 'Leavanny'],
    role: 'Grass/Bug pressures Water, Ground, Rock, Psychic, Dark, and Grass targets but carries major Fire and Flying risk.',
    offense: 'Grass STAB threatens Water, Ground, and Rock targets, while Bug STAB pressures Psychic, Dark, and Grass targets. Fire and Flying both hit for 4×, while Ice, Poison, Bug, and Rock hit for 2×. The typing needs strict matchup control and hazard awareness.',
    teamBuilding: 'Grass/Bug needs Fire and Flying answers first, then support against Ice, Poison, Bug, and Rock. Water, Rock, Steel, and Fire-resistant partners can help create safer entries.',
    related: ['grass-flying', 'fighting-bug'],
  },
  {
    slug: 'ice-fairy',
    type1: 'ice',
    type2: 'fairy',
    headline: 'Dragon immunity with a 4× Steel alarm',
    examples: ['Alolan Ninetales'],
    role: 'Ice/Fairy pressures Dragon, Flying, Grass, Ground, Dark, and Fighting targets while blocking Dragon attacks.',
    offense: 'Ice STAB threatens Dragon, Flying, Grass, and Ground targets, while Fairy STAB pressures Dragon, Dark, and Fighting targets. Steel is the severe 4× weakness, and Fire, Poison, and Rock also hit for 2×. The typing works best with speed, screens, weather, or support that prevents Steel pressure from taking over.',
    teamBuilding: 'Ice/Fairy needs Steel answers first, then Fire, Poison, and Rock support. Fire, Water, Steel, and Ground partners can cover those lanes while Ice/Fairy gives Dragon immunity.',
    related: ['flying-fairy', 'dragon-ice'],
  },
  {
    slug: 'poison-psychic',
    type1: 'poison',
    type2: 'psychic',
    headline: 'utility pressure with three 2× weaknesses',
    examples: ['Munkidori', 'Galarian Slowbro', 'Galarian Slowking'],
    role: 'Poison/Psychic pressures Fairy, Grass, Fighting, and Poison targets while resisting Fighting, Poison, Grass, and Fairy.',
    offense: 'Poison STAB threatens Fairy and Grass targets, while Psychic STAB pressures Fighting and Poison targets. Ground, Ghost, and Dark are the direct weaknesses, and there is no immunity. The typing needs support against common Earthquake, Knock Off, and Ghost pressure.',
    teamBuilding: 'Poison/Psychic wants Ground, Ghost, and Dark answers. Flying, Dark, Fairy, and Steel partners can cover those lanes while Poison/Psychic helps into Fairy and Fighting pressure.',
    related: ['poison-dark', 'psychic-ghost'],
  },
  {
    slug: 'poison-fairy',
    type1: 'poison',
    type2: 'fairy',
    headline: 'Dragon immunity with three 2× weaknesses',
    examples: ['Galarian Weezing', 'Fezandipiti'],
    role: 'Poison/Fairy blocks Dragon while pressuring Fairy, Grass, Dragon, Dark, and Fighting targets.',
    offense: 'Poison STAB threatens Fairy and Grass targets, while Fairy STAB pressures Dragon, Dark, and Fighting targets. Ground, Psychic, and Steel are the direct weaknesses, and there is no 4× weakness. The typing is useful when it can punish Fairy and Dragon lanes without giving Steel free progress.',
    teamBuilding: 'Poison/Fairy needs Ground, Psychic, and Steel answers. Flying, Dark, Fire, and Steel-resistant partners can cover those lanes while Poison/Fairy absorbs Fairy and Dragon pressure.',
    related: ['dark-fairy', 'poison-steel'],
  },
  {
    slug: 'bug-rock',
    type1: 'bug',
    type2: 'rock',
    headline: 'three weaknesses and strong Rock pressure',
    examples: ['Shuckle', 'Anorith', 'Armaldo', 'Dwebble', 'Crustle'],
    role: 'Bug/Rock pressures Psychic, Dark, Grass, Flying, Fire, Ice, and Bug targets while keeping a simple weakness list.',
    offense: 'Bug STAB threatens Psychic, Dark, and Grass targets, while Rock STAB pressures Flying, Fire, Ice, and Bug targets. Water, Rock, and Steel are the direct weaknesses, and there is no immunity. The typing often values utility, hazards, or setup to turn its coverage into progress.',
    teamBuilding: 'Bug/Rock needs Water, Rock, and Steel answers. Grass, Ground, Fighting, and bulky Water partners can cover those lanes while Bug/Rock pressures Flying and Dark targets.',
    related: ['ice-rock', 'fighting-bug'],
  },
  {
    slug: 'bug-ghost',
    type1: 'bug',
    type2: 'ghost',
    headline: 'Normal and Fighting immunities with five 2× weaknesses',
    examples: ['Shedinja'],
    role: 'Bug/Ghost blocks Normal and Fighting while threatening Psychic, Ghost, Dark, and Grass targets.',
    offense: 'Bug STAB pressures Psychic, Dark, and Grass targets, while Ghost STAB threatens Ghost and Psychic targets. Fire, Flying, Rock, Ghost, and Dark all hit for 2×, so the typing is fragile without careful positioning. Its immunities are valuable but do not cover its broad weakness spread.',
    teamBuilding: 'Bug/Ghost needs Fire, Flying, Rock, Ghost, and Dark answers. Water, Rock, Fairy, Dark, and Steel partners can cover those lanes while Bug/Ghost supplies Normal and Fighting immunities.',
    related: ['ghost-dark', 'flying-bug'],
  },
  {
    slug: 'normal-psychic',
    type1: 'normal',
    type2: 'psychic',
    headline: 'Ghost immunity with only Bug and Dark weaknesses',
    examples: ['Girafarig', 'Meloetta Aria', 'Oranguru', 'Wyrdeer', 'Farigiraf'],
    role: 'Normal/Psychic blocks Ghost while pressuring Fighting and Poison targets and keeping a short weakness list.',
    offense: 'Normal STAB gives broad neutral damage, while Psychic STAB pressures Fighting and Poison targets. Bug and Dark are the only direct weaknesses, and Ghost has no effect. The typing works best when it can use utility, bulk, or coverage to avoid being walled by Steel and Dark answers.',
    teamBuilding: 'Normal/Psychic needs Bug and Dark answers. Fairy, Fighting, Steel, and Bug-resistant partners can help while Normal/Psychic provides Ghost immunity.',
    related: ['psychic-steel', 'normal-water'],
  },
  {
    slug: 'ice-fighting',
    type1: 'ice',
    type2: 'fighting',
    headline: 'broad offense with six 2× weaknesses',
    examples: ['Crabominable'],
    role: 'Ice/Fighting pressures Dragon, Flying, Grass, Ground, Normal, Rock, Steel, Dark, and Ice targets with a very demanding defensive chart.',
    offense: 'Ice STAB threatens Dragon, Flying, Grass, and Ground targets, while Fighting STAB breaks Normal, Ice, Rock, Dark, and Steel targets. Fire, Fighting, Flying, Psychic, Steel, and Fairy all hit for 2×, so the typing must focus on offensive value. It needs support to enter safely before using its coverage.',
    teamBuilding: 'Ice/Fighting needs Fire, Fighting, Flying, Psychic, Steel, and Fairy answers. Water, Steel, Ghost, Poison, and Fire-resistant partners can cover different parts of that spread.',
    related: ['dragon-ice', 'fighting-steel'],
  },
  {
    slug: 'fire-rock',
    type1: 'fire',
    type2: 'rock',
    headline: 'two 4× weaknesses and strong Fire/Rock pressure',
    examples: ['Magcargo', 'Carkol', 'Coalossal', 'Hisuian Growlithe', 'Hisuian Arcanine'],
    role: 'Fire/Rock threatens Grass, Ice, Bug, Steel, Flying, and Fire targets but must respect severe Water and Ground pressure.',
    offense: 'Fire STAB threatens Grass, Ice, Bug, and Steel targets, while Rock STAB pressures Flying, Fire, Ice, and Bug targets. Water and Ground both hit for 4×, while Fighting and Rock hit for 2×. The typing needs strict Water and Ground support before its offensive profile can shine.',
    teamBuilding: 'Fire/Rock needs Water and Ground answers first. Grass, Flying, Water, and Ground-immune partners can cover those lanes while Fire/Rock pressures Flying, Fire, Ice, and Steel targets.',
    related: ['fire-ground', 'rock-steel'],
  },
  {
    slug: 'rock-steel',
    type1: 'rock',
    type2: 'steel',
    headline: 'Poison immunity with two 4× weaknesses',
    examples: ['Aron', 'Lairon', 'Aggron', 'Shieldon', 'Bastiodon'],
    role: 'Rock/Steel blocks Poison and resists many physical lanes, but Fighting and Ground pressure define the matchup.',
    offense: 'Rock STAB threatens Flying, Fire, Ice, and Bug targets, while Steel STAB pressures Fairy, Ice, and Rock targets. Fighting and Ground both hit for 4×, Water hits for 2×, and Poison has no effect. The typing needs dedicated support against common physical coverage.',
    teamBuilding: 'Rock/Steel needs Fighting and Ground answers first, plus Water support. Flying, Ghost, Grass, and bulky Water partners can cover those lanes while Rock/Steel provides Poison immunity and strong resistances.',
    related: ['ground-rock', 'poison-steel'],
  },
  {
    slug: 'ice-bug',
    type1: 'ice',
    type2: 'bug',
    headline: 'two 4× weaknesses with useful Ice pressure',
    examples: ['Snom', 'Frosmoth'],
    role: 'Ice/Bug pressures Dragon, Flying, Grass, Ground, Psychic, and Dark targets but has severe Fire and Rock exposure.',
    offense: 'Ice STAB threatens Dragon, Flying, Grass, and Ground targets, while Bug STAB pressures Psychic, Dark, and Grass targets. Fire and Rock both hit for 4×, while Flying and Steel hit for 2×. The typing needs hazard control and careful positioning before it can attack safely.',
    teamBuilding: 'Ice/Bug needs Fire and Rock answers first, plus Flying and Steel support. Water, Ground, Steel, and hazard-removal partners can help while Ice/Bug focuses on offensive pressure.',
    related: ['grass-bug', 'ice-rock'],
  },
  {
    slug: 'poison-rock',
    type1: 'poison',
    type2: 'rock',
    headline: 'Ground 4× pressure with strong Fairy control',
    examples: ['Nihilego', 'Glimmet', 'Glimmora'],
    role: 'Poison/Rock pressures Fairy, Grass, Flying, Fire, Ice, and Bug targets while resisting several utility lanes.',
    offense: 'Poison STAB threatens Fairy and Grass targets, while Rock STAB pressures Flying, Fire, Ice, and Bug targets. Ground is the severe 4× weakness, while Water, Psychic, and Steel hit for 2×. The typing needs Ground support before it can exploit its offensive reach.',
    teamBuilding: 'Poison/Rock needs Ground answers first, then Water, Psychic, and Steel support. Flying, Grass, Dark, Water, and Ground-resistant partners can cover those lanes.',
    related: ['poison-steel', 'bug-rock'],
  },
  {
    slug: 'flying-ghost',
    type1: 'flying',
    type2: 'ghost',
    headline: 'three immunities with five 2× weaknesses',
    examples: ['Drifloon', 'Drifblim', 'Sensu Oricorio'],
    role: 'Flying/Ghost blocks Normal, Fighting, and Ground while threatening Grass, Fighting, Bug, Ghost, and Psychic targets.',
    offense: 'Flying STAB pressures Grass, Fighting, and Bug targets, while Ghost STAB threatens Ghost and Psychic targets. Electric, Ice, Rock, Ghost, and Dark all hit for 2×, so the typing needs support against common coverage and hazards. Its triple immunity is valuable for pivots and disruption.',
    teamBuilding: 'Flying/Ghost needs Electric, Ice, Rock, Ghost, and Dark answers. Steel, Fairy, Dark, Ground, and Water partners can cover those lanes while Flying/Ghost supplies three immunities.',
    related: ['ghost-fairy', 'flying-psychic'],
  },
  {
    slug: 'normal-water',
    type1: 'normal',
    type2: 'water',
    headline: 'Ghost immunity with three 2× weaknesses',
    examples: ['Bibarel'],
    role: 'Normal/Water blocks Ghost while pressuring Fire, Ground, and Rock targets with simple neutral coverage.',
    offense: 'Normal STAB gives broad neutral damage, while Water STAB threatens Fire, Ground, and Rock targets. Electric, Grass, and Fighting are the direct weaknesses, and there is no 4× weakness. The typing works best when ability, setup, or utility gives it a clear role beyond the chart.',
    teamBuilding: 'Normal/Water wants Electric, Grass, and Fighting answers. Ground, Grass-resistant, Fairy, and Flying partners can cover those lanes while Normal/Water provides Ghost immunity.',
    related: ['water-dark', 'normal-psychic'],
  },
  {
    slug: 'normal-ground',
    type1: 'normal',
    type2: 'ground',
    headline: 'Electric and Ghost immunities with four 2× weaknesses',
    examples: ['Diggersby', 'Ursaluna', 'Bloodmoon Ursaluna'],
    role: 'Normal/Ground blocks Electric and Ghost while threatening Electric, Fire, Poison, Rock, and Steel targets.',
    offense: 'Normal STAB gives broad neutral damage, while Ground STAB pressures Electric, Fire, Poison, Rock, and Steel targets. Water, Grass, Ice, and Fighting all hit for 2×, so the typing needs defensive support despite two immunities. It is strongest when it can turn a safe immunity into immediate pressure.',
    teamBuilding: 'Normal/Ground needs Water, Grass, Ice, and Fighting answers. Grass, Water, Fairy, Flying, and Ghost partners can cover those lanes while Normal/Ground blocks Electric and Ghost pressure.',
    related: ['ground-dark', 'normal-water'],
  },
  {
    slug: 'ground-psychic',
    type1: 'ground',
    type2: 'psychic',
    headline: 'Electric immunity with six 2× weaknesses',
    examples: ['Baltoy', 'Claydol'],
    role: 'Ground/Psychic blocks Electric while threatening Electric, Fire, Poison, Rock, Steel, Fighting, and Poison targets.',
    offense: 'Ground STAB threatens Electric, Fire, Poison, Rock, and Steel targets, while Psychic STAB pressures Fighting and Poison targets. Water, Grass, Ice, Bug, Ghost, and Dark all hit for 2×, so the typing needs broad support. It often functions best through utility, hazards, or pivoting rather than raw defensive safety.',
    teamBuilding: 'Ground/Psychic needs Water, Grass, Ice, Bug, Ghost, and Dark answers. Steel, Fairy, Dark, Water, and Flying partners can cover different lanes while Ground/Psychic offers Electric immunity.',
    related: ['poison-ground', 'psychic-rock'],
  },
  {
    slug: 'normal-grass',
    type1: 'normal',
    type2: 'grass',
    headline: 'Ghost immunity with six 2× weaknesses',
    examples: ['Deerling', 'Sawsbuck', 'Smoliv', 'Dolliv', 'Arboliva'],
    role: 'Normal/Grass blocks Ghost while pressuring Water, Ground, and Rock targets and offering utility into some Electric and Grass lanes.',
    offense: 'Normal STAB gives broad neutral damage, while Grass STAB threatens Water, Ground, and Rock targets. Fire, Ice, Fighting, Poison, Flying, and Bug all hit for 2×, so the defensive chart is demanding. The typing needs speed, support, or utility to justify its many weaknesses.',
    teamBuilding: 'Normal/Grass needs Fire, Ice, Fighting, Poison, Flying, and Bug answers. Steel, Fire, Flying, Fairy, and bulky Water partners can cover different parts of that spread.',
    related: ['normal-ground', 'grass-fairy'],
  },
  {
    slug: 'flying-rock',
    type1: 'flying',
    type2: 'rock',
    headline: 'Ground immunity with five 2× weaknesses',
    examples: ['Aerodactyl', 'Archen', 'Archeops', 'Minior'],
    role: 'Flying/Rock blocks Ground while threatening Grass, Fighting, Bug, Flying, Fire, and Ice targets.',
    offense: 'Flying STAB pressures Grass, Fighting, and Bug targets, while Rock STAB threatens Flying, Fire, Ice, and Bug targets. Water, Electric, Ice, Rock, and Steel all hit for 2×. The typing needs support against common coverage and hazards, but it can apply strong fast pressure.',
    teamBuilding: 'Flying/Rock wants Water, Electric, Ice, Rock, and Steel answers. Ground, Steel, Water, and Fighting partners can cover those lanes while Flying/Rock provides Ground immunity.',
    related: ['flying-steel', 'bug-rock'],
  },
  {
    slug: 'normal-fire',
    type1: 'normal',
    type2: 'fire',
    headline: 'Ghost immunity with four 2× weaknesses',
    examples: ['Litleo', 'Pyroar'],
    role: 'Normal/Fire blocks Ghost while threatening Grass, Ice, Bug, and Steel targets with Fire pressure.',
    offense: 'Normal STAB gives broad neutral damage, while Fire STAB threatens Grass, Ice, Bug, and Steel targets. Water, Fighting, Ground, and Rock all hit for 2×, and there is no 4× weakness. The typing needs support against common physical coverage and hazards.',
    teamBuilding: 'Normal/Fire needs Water, Fighting, Ground, and Rock answers. Grass, Flying, Fairy, Water, and Ground-immune partners can cover those lanes while Normal/Fire provides Ghost immunity and Steel pressure.',
    related: ['fire-dark', 'normal-water'],
  },
];

const BATCH5_COMBINATION_GUIDE_CONFIGS: GeneratedCombinationGuideConfig[] = [
  {
    slug: 'fire-electric',
    type1: 'fire',
    type2: 'electric',
    headline: 'Ground pressure is the emergency matchup',
    examples: ['Heat Rotom'],
    role: 'Fire/Electric is a pressure pairing that threatens Steel, Grass, Ice, Bug, Water, and Flying targets while resisting several common utility attacks.',
    offense: 'Fire STAB threatens Grass, Ice, Bug, and Steel targets, while Electric STAB pressures Water and Flying targets. Ground is the severe 4× weakness, and Water and Rock also hit for 2×. The typing needs Ground control before it can repeatedly exploit its strong offensive reach.',
    teamBuilding: 'Fire/Electric needs Ground answers first, then Water and Rock support. Flying, Levitate, Grass, Water, and Ground-resistant partners can cover those lanes while Fire/Electric pressures Steel and Water structures.',
    related: ['fire-water', 'electric-flying'],
  },
  {
    slug: 'electric-fighting',
    type1: 'electric',
    type2: 'fighting',
    headline: 'physical pressure with three direct weaknesses',
    examples: ['Pawmo', 'Pawmot', 'Iron Hands'],
    role: 'Electric/Fighting pressures Water, Flying, Normal, Rock, Dark, Ice, and Steel targets with a compact but active offensive profile.',
    offense: 'Electric STAB threatens Water and Flying targets, while Fighting STAB breaks Normal, Ice, Rock, Dark, and Steel targets. Ground, Psychic, and Fairy are the chart weaknesses, and there is no 4× weakness. The typing works best when it can use bulk, priority, or pivot support to choose favorable trades.',
    teamBuilding: 'Electric/Fighting wants Ground, Psychic, and Fairy answers. Flying, Steel, Dark, Poison, and Ground-immune partners can cover those lanes while Electric/Fighting pressures bulky Water and Steel cores.',
    related: ['fighting-steel', 'electric-fairy'],
  },
  {
    slug: 'fire-grass',
    type1: 'fire',
    type2: 'grass',
    headline: 'Water pressure with three weaknesses',
    examples: ['Scovillain', 'Ogerpon Hearthflame Mask'],
    role: 'Fire/Grass is an unusual offensive pairing that pressures Water, Ground, Rock, Steel, Grass, Ice, and Bug targets.',
    offense: 'Fire STAB threatens Grass, Ice, Bug, and Steel targets, while Grass STAB pressures Water, Ground, and Rock targets. Poison, Flying, and Rock are the direct weaknesses, and there is no 4× weakness. The typing is strongest when it can punish Water and Steel answers in the same slot.',
    teamBuilding: 'Fire/Grass needs Poison, Flying, and Rock answers. Steel, Rock-resistant, Electric, and bulky Water partners can cover those lanes while Fire/Grass pressures Water and Steel structures.',
    related: ['fire-water', 'grass-rock'],
  },
  {
    slug: 'electric-dark',
    type1: 'electric',
    type2: 'dark',
    headline: 'Psychic immunity with four 2× weaknesses',
    examples: ['Morpeko Full Belly', 'Morpeko Hangry'],
    role: 'Electric/Dark blocks Psychic while threatening Water, Flying, Ghost, and Psychic targets.',
    offense: 'Electric STAB threatens Water and Flying targets, while Dark STAB pressures Ghost and Psychic targets. Fighting, Ground, Bug, and Fairy all hit for 2×. The typing needs help against common Ground and Fairy lanes, but it can create strong tempo when it pivots or forces Psychic targets out.',
    teamBuilding: 'Electric/Dark wants Fighting, Ground, Bug, and Fairy answers. Flying, Steel, Poison, Fairy, and Ground-immune partners can cover those lanes while Electric/Dark supplies Psychic immunity.',
    related: ['electric-fighting', 'normal-dark'],
  },
  {
    slug: 'electric-ice',
    type1: 'electric',
    type2: 'ice',
    headline: 'bolt-beam offense with four 2× weaknesses',
    examples: ['Arctozolt', 'Frost Rotom'],
    role: 'Electric/Ice is an offense-first pairing that pressures Water, Flying, Dragon, Grass, and Ground targets.',
    offense: 'Electric STAB threatens Water and Flying targets, while Ice STAB pressures Dragon, Flying, Grass, and Ground targets. Fire, Fighting, Ground, and Rock all hit for 2×. The typing has excellent coverage, but it needs support because several common attack types punish it defensively.',
    teamBuilding: 'Electric/Ice needs Fire, Fighting, Ground, and Rock answers. Water, Flying, Fairy, Steel, and Ground-immune partners can cover those lanes while Electric/Ice focuses on forcing damage.',
    related: ['electric-rock', 'ice-flying'],
  },
  {
    slug: 'bug-dragon',
    type1: 'bug',
    type2: 'dragon',
    headline: 'theoretical Dragon pressure with five weaknesses',
    examples: [],
    role: 'Bug/Dragon is a theoretical pairing that would threaten Psychic, Dark, Grass, and Dragon targets while resisting Water, Electric, Grass, Fighting, and Ground pressure.',
    offense: 'Bug STAB pressures Psychic, Dark, and Grass targets, while Dragon STAB supplies broad neutral damage and threatens Dragon targets. Ice, Flying, Rock, Dragon, and Fairy all hit for 2×. The page covers the combination itself; there are no established Pokemon with this exact typing.',
    teamBuilding: 'Bug/Dragon needs Ice, Flying, Rock, Dragon, and Fairy answers. Steel, Fire, Water, Fairy, and Rock-resistant partners can cover those lanes while Bug/Dragon would offer useful Grass and Ground resistance on the chart.',
    related: ['fighting-bug', 'rock-dragon'],
  },
  {
    slug: 'electric-poison',
    type1: 'electric',
    type2: 'poison',
    headline: 'Ground 4× pressure with Fairy control',
    examples: ['Toxel', 'Toxtricity Amped', 'Toxtricity Low Key'],
    role: 'Electric/Poison pressures Water, Flying, Fairy, and Grass targets while resisting Electric, Fighting, Poison, Bug, Grass, Steel, and Fairy lanes.',
    offense: 'Electric STAB threatens Water and Flying targets, while Poison STAB pressures Fairy and Grass targets. Ground is the severe 4× weakness, and Psychic hits for 2×. The typing is strongest when teammates prevent Ground attackers from entering freely.',
    teamBuilding: 'Electric/Poison needs Ground answers first, then Psychic support. Flying, Levitate, Dark, Grass, and bulky Water partners can cover those lanes while Electric/Poison checks Fairy and Water pressure.',
    related: ['electric-fairy', 'poison-fairy'],
  },
  {
    slug: 'electric-psychic',
    type1: 'electric',
    type2: 'psychic',
    headline: 'special pressure with four 2× weaknesses',
    examples: ['Alolan Raichu'],
    role: 'Electric/Psychic threatens Water, Flying, Fighting, and Poison targets while resisting Electric, Fighting, Flying, Psychic, and Steel attacks.',
    offense: 'Electric STAB threatens Water and Flying targets, while Psychic STAB pressures Fighting and Poison targets. Ground, Bug, Ghost, and Dark all hit for 2×. The typing needs support against Ground and Dark answers before it can use its speed or special pressure safely.',
    teamBuilding: 'Electric/Psychic wants Ground, Bug, Ghost, and Dark answers. Flying, Fairy, Dark, and Steel partners can cover those lanes while Electric/Psychic pressures Water and Fighting cores.',
    related: ['electric-fighting', 'psychic-bug'],
  },
  {
    slug: 'electric-bug',
    type1: 'electric',
    type2: 'bug',
    headline: 'only Fire and Rock weaknesses',
    examples: ['Joltik', 'Galvantula', 'Charjabug', 'Vikavolt'],
    role: 'Electric/Bug pressures Water, Flying, Psychic, Dark, and Grass targets with only two chart weaknesses.',
    offense: 'Electric STAB threatens Water and Flying targets, while Bug STAB pressures Psychic, Dark, and Grass targets. Fire and Rock are the only direct weaknesses, and there is no 4× weakness. The typing appreciates hazard control and support against common Rock coverage.',
    teamBuilding: 'Electric/Bug needs Fire and Rock answers. Water, Ground, Fighting, and bulky Rock-resistant partners can cover those lanes while Electric/Bug pressures Water and Psychic structures.',
    related: ['electric-grass', 'bug-dark'],
  },
  {
    slug: 'fire-ice',
    type1: 'fire',
    type2: 'ice',
    headline: 'Rock 4× pressure with strong coverage',
    examples: ['Galarian Zen Mode Darmanitan'],
    role: 'Fire/Ice is an offense-first pairing that pressures Grass, Ice, Bug, Steel, Dragon, Flying, and Ground targets.',
    offense: 'Fire STAB threatens Grass, Ice, Bug, and Steel targets, while Ice STAB pressures Dragon, Flying, Grass, and Ground targets. Rock is the severe 4× weakness, while Water, Fighting, and Ground hit for 2×. The typing needs safe entry support because hazards and Rock coverage can punish it quickly.',
    teamBuilding: 'Fire/Ice needs Rock control first, then Water, Fighting, and Ground answers. Steel, Water, Flying, and hazard-removal partners can support its strong attacking reach.',
    related: ['fire-rock', 'ice-dark'],
  },
  {
    slug: 'fighting-dragon',
    type1: 'fighting',
    type2: 'dragon',
    headline: 'Fairy 4× pressure with broad offense',
    examples: ['Hakamo-o', 'Kommo-o', 'Koraidon'],
    role: 'Fighting/Dragon pressures Normal, Rock, Steel, Dark, Ice, and Dragon targets but must respect Fairy more than anything else.',
    offense: 'Fighting STAB breaks Normal, Ice, Rock, Dark, and Steel targets, while Dragon STAB supplies broad neutral pressure and threatens Dragons. Fairy is the severe 4× weakness, while Ice, Flying, Psychic, and Dragon hit for 2×. The typing needs Fairy control before it can use its offensive profile safely.',
    teamBuilding: 'Fighting/Dragon needs Fairy answers first, then Ice, Flying, Psychic, and Dragon support. Steel, Poison, Fire, and Fairy partners can cover those lanes while Fighting/Dragon pressures Steel and Dark cores.',
    related: ['fighting-fairy', 'rock-dragon'],
  },
  {
    slug: 'electric-rock',
    type1: 'electric',
    type2: 'rock',
    headline: 'Ground 4× pressure with strong Flying control',
    examples: ['Iron Thorns', 'Alolan Geodude', 'Alolan Graveler', 'Alolan Golem'],
    role: 'Electric/Rock pressures Water, Flying, Fire, Ice, and Bug targets while resisting Normal, Fire, Electric, Poison, and Flying.',
    offense: 'Electric STAB threatens Water and Flying targets, while Rock STAB pressures Flying, Fire, Ice, and Bug targets. Ground is the severe 4× weakness, while Water, Grass, and Fighting hit for 2×. The typing needs Ground support before it can repeatedly check Flying lanes.',
    teamBuilding: 'Electric/Rock needs Ground answers first, then Water, Grass, and Fighting support. Flying, Grass, Fairy, and bulky Water partners can cover those lanes while Electric/Rock pressures Flying and Water targets.',
    related: ['electric-ground', 'flying-rock'],
  },
  {
    slug: 'ice-poison',
    type1: 'ice',
    type2: 'poison',
    headline: 'theoretical Fairy control with five weaknesses',
    examples: [],
    role: 'Ice/Poison is a theoretical pairing that would pressure Dragon, Flying, Grass, Ground, Fairy, and Grass targets while resisting Ice, Poison, Grass, and Fairy.',
    offense: 'Ice STAB threatens Dragon, Flying, Grass, and Ground targets, while Poison STAB pressures Fairy and Grass targets. Fire, Ground, Psychic, Rock, and Steel all hit for 2×. The page covers the combination itself; there are no established Pokemon with this exact typing.',
    teamBuilding: 'Ice/Poison needs Fire, Ground, Psychic, Rock, and Steel answers. Water, Flying, Dark, Fighting, and Steel-resistant partners can cover those lanes while Ice/Poison would pressure Dragon and Fairy targets on the chart.',
    related: ['ice-fairy', 'poison-rock'],
  },
  {
    slug: 'ice-flying',
    type1: 'ice',
    type2: 'flying',
    headline: 'Ground immunity with a 4× Rock alarm',
    examples: ['Articuno', 'Delibird'],
    role: 'Ice/Flying blocks Ground while pressuring Dragon, Flying, Grass, Ground, Fighting, and Bug targets.',
    offense: 'Ice STAB threatens Dragon, Flying, Grass, and Ground targets, while Flying STAB pressures Grass, Fighting, and Bug targets. Rock is the severe 4× weakness, while Fire, Electric, and Steel hit for 2×. The typing needs hazard control because Rock pressure is dangerous even before attacks are used.',
    teamBuilding: 'Ice/Flying needs Rock management first, then Fire, Electric, and Steel answers. Ground, Water, Fire-resistant, and hazard-removal partners can help create safer entries.',
    related: ['flying-rock', 'electric-ice'],
  },
  {
    slug: 'rock-dragon',
    type1: 'rock',
    type2: 'dragon',
    headline: 'wide pressure with six 2× weaknesses',
    examples: ['Tyrunt', 'Tyrantrum'],
    role: 'Rock/Dragon pressures Flying, Fire, Ice, Bug, and Dragon targets while resisting Fire, Electric, Poison, and Flying.',
    offense: 'Rock STAB threatens Flying, Fire, Ice, and Bug targets, while Dragon STAB supplies broad neutral pressure and threatens Dragons. Ice, Fighting, Ground, Dragon, Steel, and Fairy all hit for 2×. The typing needs broad defensive support because no single 4× weakness defines the matchup.',
    teamBuilding: 'Rock/Dragon needs Ice, Fighting, Ground, Dragon, Steel, and Fairy answers. Steel, Fairy, Flying, Water, and Fire partners can cover different parts of that spread.',
    related: ['dragon-fairy', 'fighting-rock'],
  },
  {
    slug: 'ice-dark',
    type1: 'ice',
    type2: 'dark',
    headline: 'Psychic immunity with a 4× Fighting alarm',
    examples: ['Sneasel', 'Weavile', 'Chien-Pao'],
    role: 'Ice/Dark blocks Psychic while threatening Dragon, Flying, Grass, Ground, Ghost, and Psychic targets.',
    offense: 'Ice STAB threatens Dragon, Flying, Grass, and Ground targets, while Dark STAB pressures Ghost and Psychic targets. Fighting is the severe 4× weakness, while Fire, Bug, Rock, Steel, and Fairy hit for 2×. The typing is dangerous offensively but needs careful support into priority and Fighting coverage.',
    teamBuilding: 'Ice/Dark needs Fighting answers first, then Fire, Bug, Rock, Steel, and Fairy support. Ghost, Fairy, Water, Steel, and Fighting-resistant partners can help.',
    related: ['ice-fighting', 'normal-dark'],
  },
  {
    slug: 'normal-fighting',
    type1: 'normal',
    type2: 'fighting',
    headline: 'Ghost immunity with four 2× weaknesses',
    examples: ['Stufful', 'Bewear', 'Pirouette Meloetta', 'Mega Lopunny'],
    role: 'Normal/Fighting blocks Ghost while pressuring Normal, Ice, Rock, Dark, and Steel targets.',
    offense: 'Normal STAB gives broad neutral damage, while Fighting STAB breaks Normal, Ice, Rock, Dark, and Steel targets. Fighting, Flying, Psychic, and Fairy all hit for 2×. The typing needs support against common revenge-kill lanes but can pressure many bulky structures.',
    teamBuilding: 'Normal/Fighting wants Fighting, Flying, Psychic, and Fairy answers. Ghost, Steel, Electric, Dark, and Poison partners can cover those lanes while Normal/Fighting supplies Ghost immunity.',
    related: ['normal-dark', 'fighting-fairy'],
  },
  {
    slug: 'bug-dark',
    type1: 'bug',
    ...
    headline: 'Psychic immunity with five 2× weaknesses',
    examples: ['Lokix'],
    role: 'Bug/Dark blocks Psychic while threatening Psychic, Ghost, Dark, and Grass targets.',
    offense: 'Bug STAB pressures Psychic, Dark, and Grass targets, while Dark STAB threatens Ghost and Psychic targets. Fire, Flying, Bug, Rock, and Fairy all hit for 2×. The typing needs speed, priority, or pivoting to turn its offensive overlap into real progress.',
    teamBuilding: 'Bug/Dark wants Fire, Flying, Bug, Rock, and Fairy answers. Steel, Fire-resistant, Poison, Rock-resistant, and Fairy partners can cover those lanes while Bug/Dark blocks Psychic attacks.',
    related: ['bug-ghost', 'normal-dark'],
  },
  {
    slug: 'normal-ghost',
    type1: 'normal',
    type2: 'ghost',
    headline: 'three immunities and only Dark weakness',
    examples: ['Hisuian Zorua', 'Hisuian Zoroark'],
    role: 'Normal/Ghost blocks Normal, Fighting, and Ghost while threatening Ghost and Psychic targets.',
    offense: 'Normal STAB gives broad neutral damage, while Ghost STAB pressures Ghost and Psychic targets. Dark is the only chart weakness, and there is no 4× weakness. The typing is powerful defensively because three immunities create many safe-turn possibilities.',
    teamBuilding: 'Normal/Ghost needs Dark answers. Fairy, Fighting, Bug, and bulky Dark-resistant partners can cover that lane while Normal/Ghost supplies Normal, Fighting, and Ghost immunities.',
    related: ['ghost-dark', 'normal-dark'],
  },
  {
    slug: 'rock-ghost',
    type1: 'rock',
    type2: 'ghost',
    headline: 'theoretical dual immunity with six weaknesses',
    examples: [],
    role: 'Rock/Ghost is a theoretical pairing that would block Normal and Fighting while threatening Flying, Fire, Ice, Bug, Ghost, and Psychic targets.',
    offense: 'Rock STAB threatens Flying, Fire, Ice, and Bug targets, while Ghost STAB pressures Ghost and Psychic targets. Water, Grass, Ground, Ghost, Dark, and Steel all hit for 2×. The page covers the combination itself; there are no established Pokemon with this exact typing.',
    teamBuilding: 'Rock/Ghost needs Water, Grass, Ground, Ghost, Dark, and Steel answers. Fairy, Dark, Water, Grass, and Steel partners can cover different parts of that spread.',
    related: ['bug-ghost', 'rock-fairy'],
  },
  {
    slug: 'rock-fairy',
    type1: 'rock',
    type2: 'fairy',
    headline: 'Dragon immunity with a 4× Steel alarm',
    examples: ['Carbink', 'Diancie', 'Mega Diancie'],
    role: 'Rock/Fairy blocks Dragon while threatening Flying, Fire, Ice, Bug, Dragon, Dark, and Fighting targets.',
    offense: 'Rock STAB threatens Flying, Fire, Ice, and Bug targets, while Fairy STAB pressures Dragon, Dark, and Fighting targets. Steel is the severe 4× weakness, while Water, Grass, and Ground hit for 2×. The typing needs Steel control before it can exploit its useful offensive pairing.',
    teamBuilding: 'Rock/Fairy needs Steel answers first, then Water, Grass, and Ground support. Fire, Water, Flying, and Ground-immune partners can help while Rock/Fairy supplies Dragon immunity.',
    related: ['ice-fairy', 'rock-steel'],
  },
  {
    slug: 'normal-dragon',
    type1: 'normal',
    type2: 'dragon',
    headline: 'Ghost immunity with four 2× weaknesses',
    examples: ['Drampa', 'Cyclizar'],
    role: 'Normal/Dragon blocks Ghost while applying broad neutral pressure and threatening Dragon targets.',
    offense: 'Normal STAB gives broad neutral damage, while Dragon STAB supplies neutral pressure and threatens Dragons. Ice, Fighting, Dragon, and Fairy all hit for 2×. The typing needs support against Fairy and Ice pressure before it can use its Ghost immunity safely.',
    teamBuilding: 'Normal/Dragon wants Ice, Fighting, Dragon, and Fairy answers. Steel, Fairy, Fire, and Ghost partners can cover those lanes while Normal/Dragon supplies Ghost immunity.',
    related: ['normal-fairy', 'rock-dragon'],
  },
  {
    slug: 'normal-dark',
    type1: 'normal',
    type2: 'dark',
    headline: 'Psychic and Ghost immunities with a 4× Fighting alarm',
    examples: ['Obstagoon', 'Alolan Rattata', 'Alolan Raticate', 'Galarian Zigzagoon', 'Galarian Linoone'],
    role: 'Normal/Dark blocks Psychic and Ghost while threatening Ghost and Psychic targets.',
    offense: 'Normal STAB gives broad neutral damage, while Dark STAB pressures Ghost and Psychic targets. Fighting is the severe 4× weakness, while Bug and Fairy hit for 2×. The typing needs Fighting control before its double immunity can become a reliable pivot tool.',
    teamBuilding: 'Normal/Dark needs Fighting answers first, then Bug and Fairy support. Ghost, Fairy, Flying, Poison, and Steel partners can cover those lanes while Normal/Dark supplies Psychic and Ghost immunities.',
    related: ['normal-ghost', 'fighting-dark'],
  },
  {
    slug: 'normal-fairy',
    type1: 'normal',
    type2: 'fairy',
    headline: 'Ghost and Dragon immunities with two weaknesses',
    examples: ['Jigglypuff', 'Wigglytuff', 'Igglybuff', 'Azurill', 'Mega Audino'],
    role: 'Normal/Fairy blocks Ghost and Dragon while threatening Dragon, Dark, and Fighting targets.',
    offense: 'Normal STAB gives broad neutral damage, while Fairy STAB pressures Dragon, Dark, and Fighting targets. Poison and Steel are the only direct weaknesses, and there is no 4× weakness. The typing is useful when it can turn immunities into support, setup, or safe pivot turns.',
    teamBuilding: 'Normal/Fairy needs Poison and Steel answers. Ground, Fire, Steel, and Poison-resistant partners can cover those lanes while Normal/Fairy provides Ghost and Dragon immunities.',
    related: ['normal-ghost', 'rock-fairy'],
  },
  {
    slug: 'normal-steel',
    type1: 'normal',
    type2: 'steel',
    headline: 'Poison and Ghost immunities with a 4× Fighting alarm',
    examples: [],
    role: 'Normal/Steel is a theoretical pairing that would block Poison and Ghost while resisting many common attacking types.',
    offense: 'Normal STAB gives broad neutral damage, while Steel STAB pressures Fairy, Ice, and Rock targets. Fighting is the severe 4× weakness, while Fire and Ground hit for 2×. The page covers the combination itself; there are no established Pokemon with this exact typing.',
    teamBuilding: 'Normal/Steel needs Fighting answers first, then Fire and Ground support. Ghost, Flying, Water, and Ground-immune partners can cover those lanes while Normal/Steel would compress Poison and Ghost immunities.',
    related: ['normal-fairy', 'rock-steel'],
  },
  {
    slug: 'psychic-bug',
    type1: 'psychic',
    type2: 'bug',
    headline: 'six weaknesses and useful anti-utility pressure',
    examples: ['Dottler', 'Orbeetle', 'Rabsca'],
    role: 'Psychic/Bug pressures Fighting, Poison, Psychic, Dark, and Grass targets but needs broad defensive support.',
    offense: 'Psychic STAB threatens Fighting and Poison targets, while Bug STAB pressures Psychic, Dark, and Grass targets. Fire, Flying, Bug, Rock, Ghost, and Dark all hit for 2×. The typing is best used for targeted pressure, utility, or support rather than repeated defensive switching.',
    teamBuilding: 'Psychic/Bug needs Fire, Flying, Bug, Rock, Ghost, and Dark answers. Water, Steel, Fairy, Dark, and Rock-resistant partners can cover different parts of that spread.',
    related: ['bug-dark', 'electric-psychic'],
  },
  {
    slug: 'normal-electric',
    type1: 'normal',
    type2: 'electric',
    headline: 'Ghost immunity with two direct weaknesses',
    examples: ['Helioptile', 'Heliolisk'],
    role: 'Normal/Electric blocks Ghost while pressuring Water and Flying targets.',
    offense: 'Normal STAB gives broad neutral damage, while Electric STAB threatens Water and Flying targets. Fighting and Ground are the only direct weaknesses, and there is no 4× weakness. The typing often relies on speed, pivoting, or ability support to make its simple chart valuable.',
    teamBuilding: 'Normal/Electric needs Fighting and Ground answers. Flying, Ghost, Grass, Fairy, and Ground-immune partners can cover those lanes while Normal/Electric supplies Ghost immunity.',
    related: ['normal-ghost', 'electric-fighting'],
  },
  {
    slug: 'normal-poison',
    type1: 'normal',
    type2: 'poison',
    headline: 'Ghost immunity with two 2× weaknesses',
    examples: ['Shroodle', 'Grafaiai'],
    role: 'Normal/Poison blocks Ghost while pressuring Fairy and Grass targets.',
    offense: 'Normal STAB gives broad neutral damage, while Poison STAB threatens Fairy and Grass targets. Ground and Psychic are the only direct weaknesses, and there is no 4× weakness. The typing appreciates utility, status, or pivoting to convert its short weakness list into progress.',
    teamBuilding: 'Normal/Poison wants Ground and Psychic answers. Flying, Dark, Steel, and Grass partners can cover those lanes while Normal/Poison supplies Ghost immunity and Fairy pressure.',
    related: ['normal-fairy', 'poison-fairy'],
  },
  {
    slug: 'normal-ice',
    type1: 'normal',
    type2: 'ice',
    headline: 'theoretical Ghost immunity with a 4× Fighting alarm',
    examples: [],
    role: 'Normal/Ice is a theoretical pairing that would block Ghost while threatening Dragon, Flying, Grass, and Ground targets.',
    offense: 'Normal STAB gives broad neutral damage, while Ice STAB pressures Dragon, Flying, Grass, and Ground targets. Fighting is the severe 4× weakness, while Fire, Rock, and Steel hit for 2×. The page covers the combination itself; there are no established Pokemon with this exact typing.',
    teamBuilding: 'Normal/Ice needs Fighting answers first, then Fire, Rock, and Steel support. Ghost, Water, Steel, and Fire-resistant partners can cover those lanes while Normal/Ice would offer Ghost immunity on the chart.',
    related: ['normal-fighting', 'ice-dark'],
  },
  {
    slug: 'normal-bug',
    type1: 'normal',
    type2: 'bug',
    headline: 'theoretical Ghost immunity with three weaknesses',
    examples: [],
    role: 'Normal/Bug is a theoretical pairing that would block Ghost while pressuring Psychic, Dark, and Grass targets.',
    offense: 'Normal STAB gives broad neutral damage, while Bug STAB pressures Psychic, Dark, and Grass targets. Fire, Flying, and Rock are the direct weaknesses, and there is no 4× weakness. The page covers the combination itself; there are no established Pokemon with this exact typing.',
    teamBuilding: 'Normal/Bug wants Fire, Flying, and Rock answers. Water, Rock-resistant, Steel, and Electric partners can cover those lanes while Normal/Bug would provide Ghost immunity.',
    related: ['normal-ghost', 'bug-dark'],
  },
  {
    slug: 'normal-rock',
    type1: 'normal',
    ...
    headline: 'theoretical Ghost immunity with a 4× Fighting alarm',
    examples: [],
    role: 'Normal/Rock is a theoretical pairing that would block Ghost while threatening Flying, Fire, Ice, and Bug targets.',
    offense: 'Normal STAB gives broad neutral damage, while Rock STAB pressures Flying, Fire, Ice, and Bug targets. Fighting is the severe 4× weakness, while Water, Grass, Ground, and Steel hit for 2×. The page covers the combination itself; there are no established Pokemon with this exact typing.',
    teamBuilding: 'Normal/Rock needs Fighting answers first, then Water, Grass, Ground, and Steel support. Ghost, Flying, Grass, Water, and Steel partners can cover different parts of that spread.',
    related: ['normal-steel', 'rock-fairy'],
  },
];

Object.assign(
  COMBINATION_GUIDES,
  Object.fromEntries([...GENERATED_COMBINATION_GUIDE_CONFIGS, ...BATCH3_COMBINATION_GUIDE_CONFIGS, ...BATCH4_COMBINATION_GUIDE_CONFIGS, ...BATCH5_COMBINATION_GUIDE_CONFIGS].map(config => [config.slug, makeGeneratedCombinationGuide(config)]))
);
