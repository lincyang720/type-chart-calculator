...
# Pokemon Type Chart 2026 - Complete Guide for Scarlet & Violet
...
Ready to check specific matchups? Try these:

- **[Type Calculator](/calculator)** — Check any type combination's weaknesses and resistances
- **[All Types](/types)** — Detailed page for each of the 18 types
- **[Dual Type Combos](/combo/steel-fairy)** — Explore all 153 dual-type combinations
- **[Pokemon Guides](/pokemon)** — Weakness guides for popular Pokemon
- **[Battle Simulator](/battle-simulator)** — Test matchups in practice

---

*Last updated: March 2026. Type chart data is accurate for Pokemon Scarlet & Violet (Gen 9), including The Indigo Disk DLC.*
